...
public:
    ...
    /// \param w The width of the rectangle.
    /// \param h The height of the rectangle.
	ofRectangle(const ImVec2& p, float w, float h);
	...
	ofRectangle(const ImVec2& p0, const ImVec2& p1);
    ...
    /// \param w The new width.
    /// \param h The new height.
	void set(const ImVec2& p, float w, float h);
	...
	void set(const ImVec2& p0, const ImVec2& p1);
    ...
    /// \param w The width of the rectangle.
    /// \param h The height of the rectangle.
	void setFromCenter(const ImVec2& p, float w, float h);
	...
	void translate(const ImVec2& dp);
    ...
    ///
    /// \param s The scaling factor.
	void scaleFromCenter(const ImVec2& s);
	...
	void alignTo(const ImVec2& targetPoint,
				ofAlignHorz thisHorzAnchor = OF_ALIGN_HORZ_CENTER,
	...
	bool inside(const ImVec2& p) const;
	...
	bool inside(const ImVec2& p0, const ImVec2& p1) const;
	...
	void growToInclude(const ImVec2& p);
	...
	void growToInclude(const ImVec2& p0, const ImVec2& p1);
    ...
    ImVec2 map(const ImVec2 & coeff) const;
    ...
    ImVec2 mapClamp(const ImVec2 & coeff) const;
	...
	ofRectangle operator + (const ImVec2& p);
