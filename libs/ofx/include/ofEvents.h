...
enum ofKey{
    ...
    OF_MOUSE_BUTTON_RIGHT  = OF_MOUSE_BUTTON_2,
	OF_MOUSE_BUTTON_MIDDLE = OF_MOUSE_BUTTON_3,
};
...
class ofMouseEventArgs : public ofEventArgs, public ImVec2 {
  public:
	enum Type{
		Pressed,
		Moved,
...
class ofTouchEventArgs : public ofEventArgs, public ImVec2 {
  public:
	enum Type{
		down,
		up,
...
class ofWindowPosEventArgs : public ofEventArgs, public ImVec2  {
public:
